...
/**
 * useScrollReveal — adds `.revealed` class to elements when they enter the viewport.
 * Targets elements with classes: reveal, reveal-left, reveal-right, reveal-scale.
 * Also triggers animated progress bars.
 */
...
/** useCountUp — animates a number from 0 to its target when visible */
