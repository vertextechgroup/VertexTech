export const siteSettings = {
  ...
  nav: {
    ...
    ctas: [
      { name: 'Start Project', href: '/contact', variant: 'default' },
    ],
  },
  hero: {
    ...
    subtitle:
      'Enterprise web development, cybersecurity, and AI agent automation — unified under one platform for digital growth.',
