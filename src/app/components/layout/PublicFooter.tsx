      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
            ...
            <div className="flex gap-3">
              {socials.map(({ Icon, href, label }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-9 h-9 rounded-lg bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-gray-700 hover:text-white transition-all duration-200"
                >
        ...
        <div className="mt-14 border-t border-gray-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            © {new Date().getFullYear()} VertexTech. All rights reserved.
          </p>
