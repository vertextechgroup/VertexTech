...
import {
  ArrowRight, Cloud, Shield, Code, BarChart3, CheckCircle2, Star,
  Quote, MapPin, Phone, Mail, Clock, Zap, Lock, Globe, Activity,
  ChevronDown
} from 'lucide-react';
      ...
      ([entry]) => {
        if (entry.isIntersecting) {
          ...
          const step = (ts: number) => {
            ...
            el.textContent = (value >= 1000 ? Math.floor(eased * value).toLocaleString() : (eased * value).toFixed(value < 1 ? 3 : 0)) + suffix;
    ...
    <section className="bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('../assets/images/landing-immigration/map.svg')",
          }}
        >
          <div className="grid lg:grid-cols-2 gap-12 items-center py-20">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold my-6 leading-tight">
              ...
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition active:scale-95">
                Enquire now
              </button>
            ...
            <div className="relative flex justify-center">
              ...
              {/* Main Circle */}
              <img
                src="../assets/images/landing-immigration/circle.png"
                alt="circle"
              ...
              {/* Plane Image */}
              <img
                src="../assets/images/landing-immigration/plane.png"
                alt="plane"
              ...
              {/* Girl Image Centered */}
              <img
                src="../assets/images/landing-immigration/girl.png"
                alt="student"
                className="absolute top-1/2 left-1/2 w-52 -translate-x-1/2 -translate-y-1/2"
              />

              {/* Floating Labels */}
              <div className="hidden md:block absolute top-16 left-0 bg-white shadow-md border rounded-full px-4 py-2 text-sm">
                Highly Qualified Teachers
              </div>

              <div className="hidden md:block absolute top-40 left-0 bg-white shadow-md border rounded-full px-4 py-2 text-sm">
                Online and Offline Classes
              </div>

              <div className="hidden md:block absolute bottom-16 left-0 bg-white shadow-md border rounded-full px-4 py-2 text-sm">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16 reveal">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Our four-step framework delivers comprehensive protection from day one.
            </p>
          </div>
            ...
            {howItWorks.map((item, idx) => (
              ...
              >
                <div className="relative inline-flex mb-6">
                  <div
                    className="w-16 h-16 rounded-2xl theme-gradient flex items-center justify-center text-white font-extrabold text-lg shadow-lg group-hover:scale-110 transition-transform duration-300"
                  >
                    {item.step}
                  </div>
                  <div
                    className="absolute -inset-1 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity"
                    style={{ background: 'var(--theme-glow)', filter: 'blur(12px)', zIndex: -1 }}
                  />
                </div>
      ...
      {/* ─────────── SECURITY CAPABILITIES (PROGRESS BARS) ─────────── */}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="reveal">
                ...
                <p className="text-lg text-gray-600 mb-10 leading-relaxed">
                  Our AI-driven platform consistently outperforms the competition across every
                  key security measurement — because your protection depends on it.
                </p>
              </div>
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {[
                { icon: Shield, title: 'Zero-Day Protection', desc: 'Behavioral AI stops novel threats before signatures exist.' },
                { icon: Cloud, title: 'Cloud Native', desc: 'Seamless coverage across AWS, Azure, and GCP environments.' },
                { icon: Zap, title: 'Auto Response', desc: 'Sub-second automated containment with full audit trails.' },
                { icon: Lock, title: 'Zero Trust', desc: 'Never trust, always verify — enforced across every identity.' },
              ].map((feat, idx) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="w-12 h-12 rounded-xl theme-gradient flex items-center justify-center mb-4 group-hover:scale-110 transition-transform"
                    >
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16 reveal">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              From endpoint to cloud, protect and scale every layer of your digital infrastructure.
            </p>
          </div>
            ...
            {mockServices.map((service, idx) => {
              ...
              return (
                ...
                >
                  <CardHeader>
                    <div
                      className="w-14 h-14 rounded-xl theme-gradient flex items-center justify-center mb-4 group-hover:scale-110 transition-transform"
                    >
              ...
              >
                ...
                <CardContent>
                  ...
                  <Link to={`/portfolio/${project.slug}`}>
                    <Button variant="ghost" className="w-full theme-text hover:bg-gray-50">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="reveal-left">
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Ready to strengthen your security posture? Our team of cybersecurity experts
                is available 24/7 to assess your needs and recommend the right protection.
              </p>
              <div className="space-y-4">
                {[
                  { Icon: MapPin, label: 'VertexTech HQ', sub: '123 Tech Street, San Francisco, CA 94105' },
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          <div className="reveal">
            ...
            <p className="text-xl text-white/80 mb-10 max-w-2xl mx-auto">
              Join 2,000+ security teams that trust VertexTech to protect their endpoints,
              cloud, and identities.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Link to="/pricing">
                <Button size="lg" className="bg-white text-gray-900 hover:bg-gray-100 font-bold rounded-xl px-8 h-12 shadow-lg">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16 reveal">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Trends, best practices, and expert insights in enterprise technology.
            </p>
          </div>
                ...
                <CardContent>
                  <div className="flex items-center justify-between">
                    ...
                    <Link to={`/blog/${post.slug}`}>
                      <Button variant="ghost" size="sm" className="theme-text text-xs">
