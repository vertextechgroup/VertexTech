      ...
      <section className="relative py-24 overflow-hidden theme-bg-light hero-grid-bg">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl font-extrabold text-gray-900 mb-6 animate-fade-in-up delay-100">
            Talk to a{' '}
            <span className="theme-gradient-text">Security Expert</span>
          </h1>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
                  ...
                  {submitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            required
                            className="rounded-xl border-gray-200 focus:border-transparent"
                          />
                        </div>
                        <div className="space-y-2">
                      ...
                      <Button
                        type="submit"
                        size="lg"
                        className="theme-btn w-full rounded-xl h-12 font-bold"
                        disabled={submitting}
                      >
                        {submitting ? (
                          <>
                            <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-rotate mr-2" />
                            Sending...
                          </>
                        ) : (
                          <>
            ...
            <div className="reveal-right space-y-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {contactInfo.map((info) => {
                  ...
                  return (
                    <div
                      key={info.title}
                      className="bg-gray-50 rounded-2xl p-5 border border-gray-100 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
                    >
                      ...
                      {info.link ? (
                        <a href={info.link} className="text-sm theme-text hover:underline leading-snug">
                          {info.content}
                        </a>
                      ) : (
                        <p className="text-sm text-gray-600 leading-snug">{info.content}</p>
                      )}
                    </div>
                  );
                })}
              ...
              {/* Emergency */}
              <div
                className="rounded-2xl p-6 text-white theme-gradient"
              >
                ...
                <a
                  ...
                  className="text-2xl font-extrabold text-white block hover:text-white/90 transition-colors"
                >
                  +1 (555) 123-4567
                </a>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {offices.map((office, idx) => (
              <Card
                key={office.city}
                className="reveal hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group border-0 shadow-md"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden h-72 flex items-center justify-center shadow-inner reveal">
            <div className="text-center">
              <div
                className="w-16 h-16 rounded-2xl theme-gradient flex items-center justify-center mx-auto mb-4"
              >
