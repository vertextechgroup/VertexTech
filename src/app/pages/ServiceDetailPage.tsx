                ...
                <CardContent className="pt-6">
                  ...
                  <div className="prose prose-gray max-w-none">
                    <p className="text-gray-600 mb-4">
                      Our {service.title} service is designed to meet the needs of modern enterprises.
                      With years of experience and a proven track record, we deliver solutions that drive real business value.
                    </p>
                    <p className="text-gray-600">
                      Whether you're looking to optimize your existing infrastructure or build something entirely new,
                    ...
                    <div className="space-y-4">
                      <div className="border rounded-lg p-4">
                        <div className="flex items-baseline justify-between mb-2">
                          ...
                          <div>
                            <span className="text-2xl font-bold">${service.pricing.basic.toLocaleString()}</span>
                      ...
                      <div className="border-2 border-blue-600 rounded-lg p-4 bg-blue-50">
                        ...
                        <div className="flex items-baseline justify-between mb-2">
                          ...
                          <div>
                            <span className="text-2xl font-bold">${service.pricing.professional.toLocaleString()}</span>
                            <span className="text-gray-600 text-sm">/mo</span>
                          </div>
                        </div>
                      ...
                      <div className="border rounded-lg p-4">
                        <div className="flex items-baseline justify-between mb-2">
                          ...
                          <div>
                            <span className="text-2xl font-bold">${service.pricing.enterprise.toLocaleString()}</span>
                            <span className="text-gray-600 text-sm">/mo</span>
                          </div>
                        </div>
