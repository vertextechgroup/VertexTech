      ...
      <section className="relative py-24 overflow-hidden theme-bg-light hero-grid-bg">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl font-extrabold text-gray-900 mb-6 animate-fade-in-up delay-100">
            Security{' '}
            <span className="theme-gradient-text">Intelligence</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto animate-fade-in-up delay-200 leading-relaxed">
            Expert analysis, threat reports, and best practices from our cybersecurity team.
          </p>
          {/* Search bar */}
          <div className="mt-8 max-w-md mx-auto animate-fade-in delay-300">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 bg-white shadow-sm text-sm focus:outline-none focus:ring-2 transition-shadow"
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="reveal">
            <p className="text-xs font-bold uppercase tracking-widest theme-text mb-4">Featured Article</p>
          </div>
          <div className="reveal">
                ...
                <div className="flex flex-col justify-center p-10">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link to={`/blog/${featuredPost.slug}`}>
                      <Button className="theme-btn rounded-xl font-semibold">
      ...
      <section className="py-16 bg-gray-50">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="flex items-center justify-between mb-10 reveal">
            ...
            <span className="text-sm text-gray-400">{mockBlogPosts.length} articles</span>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {mockBlogPosts.map((post, idx) => (
              <Card
                key={post.id}
                className="reveal overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group border-0 shadow-md bg-white"
              ...
              >
                ...
                <CardContent>
                  ...
                  <Link to={`/blog/${post.slug}`}>
                    <Button
                      variant="ghost"
                      className="w-full mt-4 theme-text hover:bg-gray-50 text-sm font-semibold"
                    >
      ...
      <section className="py-24 theme-gradient">
        <div className="mx-auto max-w-3xl px-6 lg:px-8 text-center reveal">
          ...
          <p className="text-xl text-white/80 mb-8 leading-relaxed">
            Get weekly threat intelligence and security insights delivered directly to your inbox.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              type="email"
              placeholder="Enter your email"
              className="flex-1 px-5 py-3 rounded-xl border-0 text-gray-900 text-sm focus:outline-none focus:ring-2 shadow-sm"
              style={{ '--tw-ring-color': 'rgba(255,255,255,0.5)' } as React.CSSProperties}
            />
            <Button className="bg-white text-gray-900 hover:bg-gray-100 font-bold rounded-xl px-6 h-12 shadow-sm whitespace-nowrap">
              Subscribe
            </Button>
          </div>
