        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl font-extrabold text-gray-900 mb-6 animate-fade-in-up delay-100">
              Defending the{' '}
              <span className="theme-gradient-text">Digital Frontier</span>
            </h1>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16 reveal">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              The guiding principles that shape every solution we build.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {principles.map((p, idx) => {
              ...
              return (
                <div
                  key={p.title}
                  className="reveal-scale text-center p-8 rounded-2xl border border-gray-100 bg-gray-50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group"
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <div
              ...
              style={{ background: 'linear-gradient(to bottom, var(--theme-gradient-from), var(--theme-gradient-to))' }}
            />
            <div className="space-y-10">
              {milestones.map((m, i) => (
                <div
                  key={m.year}
                  className="reveal flex gap-8 items-start pl-4"
                  style={{ transitionDelay: `${i * 0.1}s` }}
                >
                  <div
                    className="relative z-10 w-10 h-10 rounded-full theme-gradient flex items-center justify-center text-white text-xs font-bold shrink-0 shadow-lg"
                  >
                    {i + 1}
                  </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((v, idx) => {
              ...
              return (
                <Card
                  key={v.title}
                  className="reveal text-center hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, idx) => (
              <Card
                key={member.name}
                className="reveal text-center hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group overflow-hidden"
                style={{ transitionDelay: `${idx * 0.12}s` }}
              >
                <CardContent className="pt-8 pb-6">
                  <div className="relative inline-block mb-5">
                    ...
                    />
                    <div
                      className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full theme-gradient flex items-center justify-center shadow-sm"
                    >
